...
class LakshyaNet(nn.Module):
    def __init__(self):
        ...
        self.learnable_pool = nn.Conv2d(128, 128, kernel_size=16, groups=128)
...
def train_and_validate(dataset_type, test_fold):
    ...
    log_dir = Path("/home/bsmse2/CNN_project/logs/sipakmed_logs/")
    ...
    # Save trained model
    model_dir = Path("/home/bsmse2/CNN_project/models/sipakmed")
